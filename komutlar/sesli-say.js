...
module.exports.run = async (client, message, args) => {
  ...
  .setAuthor('Bilgi', `${message.author.displayAvatarURL}`)
        ...
        .setTimestamp()
        .setFooter(`Developed : https://cdn.discordapp.com/avatars/434767868589113345/a_0ba16a5345e708d04448643345f658b0.gif?size=2048`) //asreaper sunucusu varrrrrrrrrrrrrr
