...
exports.run = (client, message, args) => {
    ...
    if (!message.member.hasPermission("MANAGE_CHANNELS")) return message.reply('Bunun için gerekli iznin yok'); // Bunu Başkasında Kullanan Bilmesi İçin Kanalları Yönet Yetkisi Verin
